...
def home():
    ...
    df = pd.DataFrame([["Player","Overs","Maidens","Runs","Wickets","Economy","Dots","4s","6s","Wide balls","No balls","Match id","Season","Fantasy points","Team","Opponent team","Match location","Toss winner","Toss winners' choice"],["Player","Overs","Maidens","Runs","Wickets","Economy","Dots","4s","6s","Wide balls","No balls","Match id","Season","Fantasy points","Team","Opponent team","Match location","Toss winner","Toss winners' choice"]], columns=("Bowling Data Includes","Batting Data Includes"))
    st.table(df)
